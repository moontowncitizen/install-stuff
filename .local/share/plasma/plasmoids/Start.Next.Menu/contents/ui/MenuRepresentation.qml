        ...
        FocusScope {
            ...
            ComboBox {
                ...
                Component.onCompleted: {
                    currentIndex = 0 // Inicializa el índice al primer elemento
                    console.log("Component initialized. currentIndex:", currentIndex)
                    console.log("Initial showApps.value:", showApps.value)
                }

                onActivated: {
                    showApps.value = currentValue // Actualiza showApps.value al cambiar la selección
                    console.log("onActivated - showApps.value:", showApps.value)
                }

                onAccepted: {
                    currentIndex = indexOfValue(showApps.value)
                    console.log("onAccepted - currentIndex:", currentIndex)
                }
            }
